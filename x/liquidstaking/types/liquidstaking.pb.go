...
// source: persistence/liquidstaking/v1beta1/liquidstaking.proto
...
type LiquidValidatorState struct {
	...
	Status ValidatorStatus `protobuf:"varint,3,opt,name=status,proto3,enum=persistence.liquidstaking.v1beta1.ValidatorStatus" json:"status,omitempty"`
...
func init() {
	proto.RegisterEnum("persistence.liquidstaking.v1beta1.ValidatorStatus", ValidatorStatus_name, ValidatorStatus_value)
	proto.RegisterType((*Params)(nil), "persistence.liquidstaking.v1beta1.Params")
	proto.RegisterType((*WhitelistedValidator)(nil), "persistence.liquidstaking.v1beta1.WhitelistedValidator")
	proto.RegisterType((*LiquidValidator)(nil), "persistence.liquidstaking.v1beta1.LiquidValidator")
	proto.RegisterType((*LiquidValidatorState)(nil), "persistence.liquidstaking.v1beta1.LiquidValidatorState")
	proto.RegisterType((*NetAmountState)(nil), "persistence.liquidstaking.v1beta1.NetAmountState")
	proto.RegisterType((*VotingPower)(nil), "persistence.liquidstaking.v1beta1.VotingPower")
}

func init() {
	proto.RegisterFile("persistence/liquidstaking/v1beta1/liquidstaking.proto", fileDescriptor_f11ef7f6d0889fb0)
}
