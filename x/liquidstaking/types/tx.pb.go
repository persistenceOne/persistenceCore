...
// source: persistence/liquidstaking/v1beta1/tx.proto
...
func init() {
	proto.RegisterType((*MsgLiquidStake)(nil), "persistence.liquidstaking.v1beta1.MsgLiquidStake")
	proto.RegisterType((*MsgLiquidStakeResponse)(nil), "persistence.liquidstaking.v1beta1.MsgLiquidStakeResponse")
	proto.RegisterType((*MsgLiquidUnstake)(nil), "persistence.liquidstaking.v1beta1.MsgLiquidUnstake")
	proto.RegisterType((*MsgLiquidUnstakeResponse)(nil), "persistence.liquidstaking.v1beta1.MsgLiquidUnstakeResponse")
}

func init() {
	proto.RegisterFile("persistence/liquidstaking/v1beta1/tx.proto", fileDescriptor_9fe270968086aea1)
}
...
func (c *msgClient) LiquidStake(ctx context.Context, in *MsgLiquidStake, opts ...grpc.CallOption) (*MsgLiquidStakeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/persistence.liquidstaking.v1beta1.Msg/LiquidStake", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) LiquidUnstake(ctx context.Context, in *MsgLiquidUnstake, opts ...grpc.CallOption) (*MsgLiquidUnstakeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/persistence.liquidstaking.v1beta1.Msg/LiquidUnstake", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_LiquidStake_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/persistence.liquidstaking.v1beta1.Msg/LiquidStake",
	}
...
func _Msg_LiquidUnstake_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/persistence.liquidstaking.v1beta1.Msg/LiquidUnstake",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "persistence.liquidstaking.v1beta1.Msg",
	...
	Metadata: "persistence/liquidstaking/v1beta1/tx.proto",
}
