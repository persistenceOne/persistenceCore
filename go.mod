...
require (
	...
	github.com/persistenceOne/pstake-native/v2 v2.0.2
...
// Firehose support
replace (
	github.com/cosmos/cosmos-sdk => github.com/persistenceOne/cosmos-sdk v0.45.14-pfh
	github.com/tendermint/tendermint => github.com/persistenceOne/infsys-tendermint v0.34.26-pfh
)
