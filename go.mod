...
// Firehose support
replace (
	github.com/cosmos/cosmos-sdk => github.com/persistenceOne/cosmos-sdk v0.45.12-pfh
	github.com/tendermint/tendermint => github.com/persistenceOne/infsys-tendermint v0.34.25-pfh
)
