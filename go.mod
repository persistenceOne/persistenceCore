...
require (
	...
	github.com/persistenceOne/pstake-native v1.2.1
...
replace github.com/cosmos/cosmos-sdk => github.com/betterclever/cosmos-sdk v0.45.10-fh

replace github.com/tendermint/tendermint => github.com/betterclever/tendermint v0.34.22-fh
