...
func Setup(isCheckTx bool) *Application {
...
func AddTestAddrsFromPubKeys(app *Application, ctx sdk.Context, pubKeys []cryptotypes.PubKey, accAmt sdk.Int) {
...
func AddTestAddrs(app *Application, ctx sdk.Context, accNum int, accAmt sdk.Int) []sdk.AccAddress {
	return addTestAddrs(app, ctx, accNum, accAmt, createRandomAccounts)
}

// AddTestAddrs constructs and returns accNum amount of accounts with an
// initial balance of accAmt in random order
func AddTestAddrsIncremental(app *Application, ctx sdk.Context, accNum int, accAmt sdk.Int) []sdk.AccAddress {
	return addTestAddrs(app, ctx, accNum, accAmt, createIncrementalAccounts)
}

func addTestAddrs(app *Application, ctx sdk.Context, accNum int, accAmt sdk.Int, strategy GenerateAccountStrategy) []sdk.AccAddress {
...
func InitAccountWithCoins(app *Application, ctx sdk.Context, addr sdk.AccAddress, coins sdk.Coins) {
...
func CheckBalance(t *testing.T, app *Application, addr sdk.AccAddress, balances sdk.Coins) {
...
func NewAppConstructor(encodingCfg params.EncodingConfig, db *dbm.MemDB) network.AppConstructor {
	return func(val network.Validator) types.Application {
		...
		return NewApplication().Initialize(
			...
			val.Ctx.Logger, db, nil, true, 0,  make(map[int64]bool), val.Ctx.Config.RootDir,
