module github.com/persistenceOne/persistenceCore/v12/interchaintest
...
require (
	...
	github.com/persistenceOne/pstake-native/v3 v2.11.0
...
replace github.com/cosmos/cosmos-sdk => github.com/persistenceOne/cosmos-sdk v0.47.3-lsm5
