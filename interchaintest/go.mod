module github.com/persistenceOne/persistenceCore/v13/interchaintest
...
require (
	...
	github.com/persistenceOne/pstake-native/v4 v4.0.0-rc0
...
replace (
	...
	github.com/cosmos/interchain-security/v3 => github.com/cosmos/interchain-security/v3 v3.3.0
